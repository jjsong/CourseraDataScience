...
This file is codebook decribing the data and variables. 


### Description Data Set

This data we using is from here 
...
# The Dataset includes the follwing files : 
- 'README.txt'
...
# Making one data set 
In order to analize the data set and make tidy data set, blinding the original data set
```{r}
...
# Rearrange the data set and making tidy data set
Subsetting columns, inserting names and writing the final tidy data set
```{r}
